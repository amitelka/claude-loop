...
# a denominator for precision/recall. Deterministic, explainable, no model in the path. Prompt text on
# stdin (unbounded). Env in: MEM_INDEX (MEMORY.md path), SID (session_id), PID (prompt_id), MV (version).
...
sys.stdout.write(json.dumps({
    ...
    "nq": len(q), "top": top, "verdict": verdict}, separators=(",", ":")))
